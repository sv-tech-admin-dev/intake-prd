-- Supabase schema for the intake PRD app.
-- Canonical migration lives in supabase/migrations/.
-- Use this file in the SQL editor if you prefer to paste the schema manually.
